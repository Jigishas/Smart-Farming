...
def selective_train_optimized(model_path='plant_model.pth', data_dir='MasterDataset', epochs=1, batch_size=32, learning_rate=0.001):
    ...
    # Load model
    model = get_model(num_classes, variant='b1').to(device)
    ...
    print(f'Overall validation accuracy after selective training: {overall_accuracy:.2f}%')
